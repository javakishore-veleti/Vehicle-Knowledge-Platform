...
@Component({
  ...
  styles: [`
    ...
    .t .dim { color:#94a3b8; font-size:.92rem; }
    .arch .note { background:#f1fdf7; border:1px solid #c5f0db; border-left:3px solid #0f8a5f; border-radius:6px; padding:.6rem .85rem; font-size:.96rem; line-height:1.6; color:#344054; }
