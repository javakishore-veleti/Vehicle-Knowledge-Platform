...
@Component({
  ...
  styles: [`
    ...
    .arch p { line-height:1.65; color:#344054; font-size:1.02rem; }
    ...
    .arch .note { background:#fff7ed; border:1px solid #fde0b0; border-left:3px solid #f59e0b; border-radius:6px; padding:.7rem .95rem; font-size:1.02rem; line-height:1.65; color:#344054; }
