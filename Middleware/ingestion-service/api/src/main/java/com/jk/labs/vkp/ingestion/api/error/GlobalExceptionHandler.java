package com.jk.labs.vkp.ingestion.api.error;

import com.jk.labs.vkp.ingestion.common.error.AirflowGatewayException;
import com.jk.labs.vkp.ingestion.common.error.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleGateway(AirflowGatewayException ex, HttpServletRequest req) {
        log.warn("airflow-adapter gateway error: {}", ex.getMessage());
