...
**Haystack:** 25/50 — Reflection ✅ + Tree-of-Thoughts ✅ + Multi-agent ✅ + Chaining ✅ + Router ✅ (all verified live via `hay.complete` over the shared `_base` catalogs). **Left (Haystack):** evaluator, rewoo, plan-execute, rag, react.
