...
**OpenAI Agents:** 25/50 — Reflection ✅ + Tree-of-Thoughts ✅ + Multi-agent ✅ + Chaining ✅ + Router ✅ (all verified live via `oa.complete` over the shared `_base` catalogs). **Left (OpenAI Agents):** evaluator, rewoo, plan-execute, rag, react.
